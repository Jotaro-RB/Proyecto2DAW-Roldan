...
<head>
    ...
    <title>Recetario Pro - Inicio</title>
...
<body>
    <div class="main-wrapper">
        <aside class="sidebar">
            ...
            <nav class="nav-menu">
                <a href="index.php?action=home" class="active">🏠 Inicio</a>
    ...
    <div class="post-actions">
        <?php if (isset($_SESSION['user_id'])): ?>
            ...
            <button type="button" class="action-btn" onclick="document.getElementById('comment-<?php echo $receta['id']; ?>').focus()">💬</button>

            <a href="index.php?action=compartir&id=<?php echo $receta['id']; ?>" 
               class="action-btn" style="text-decoration: none;">🔄</a>
        <?php else: ?>
            <a href="index.php?action=registro" class="action-btn" title="Regístrate" style="text-decoration: none;">❤️</a>
            <a href="index.php?action=registro" class="action-btn" title="Regístrate" style="text-decoration: none;">💬</a>
            <a href="index.php?action=registro" class="action-btn" title="Regístrate" style="text-decoration: none;">🔄</a>
        <?php endif; ?>
    </div>
    ...
    <div class="comments-list">
        <?php if (!empty($receta['comentarios'])): 
            foreach ($receta['comentarios'] as $com): ?>
                <div class="comment-item" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 5px;">
                    <div>
    ...
    <div class="comment-box">
        <form action="index.php?action=comentar" method="POST">
            ...
            <input type="text" name="contenido" id="comment-<?php echo $receta['id']; ?>" 
